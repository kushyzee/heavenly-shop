  ...
  return (
    <PageSection>
      ...
      {loading ? (
        ...
        <section className="mx-auto mt-9 grid min-h-svh max-w-md grid-cols-2 items-center justify-between gap-2 sm:max-w-full sm:grid-cols-3 md:gap-4 md:gap-y-4 lg:grid-cols-4">
          {products.map((product) => (
            <div
              key={product.name}
              className="min-h-60 grow rounded-md border border-neutral-300 bg-white shadow md:p-4"
            >
              <img
